...
chara_pool = {
    ...
    "Pepe": Chara("Sargon", "Tenacity"), "Estelle": Chara("Sargon"), "Papyrus": Chara("Sargon"), "Philae": Chara("Sargon"), "Gavial the Invincible": Chara("Sargon"),
    ...
    "Insider": Chara("Laterano", "Swift"), "Executor": Chara("Laterano", "Precision"), "Lemuen": Chara("Laterano", "Precision"), "Mostima": Chara("Laterano", "Arcane"), "Exusiai": Chara("Laterano"),
    "Sankta Miksaparato": Chara("Laterano", "Bastion"), "Executor the Ex Foedere": Chara("Laterano"), "Enforcer": Chara("Laterano"), "Virtuosa": Chara("Laterano"), "Exusiai the New Covenant": Chara("Laterano"),

    "Underflow": Chara("Aegir"), "Lucilla": Chara("Aegir", "Arcane"), "Skadi": Chara("Aegir", "Bastion", "Assault"), "Specter the Unchained": Chara("Aegir", "Tenacity"), "Mizuki": Chara("Aegir", "Solitary"),
    "Specter": Chara("Aegir"), "Gladiia": Chara("Aegir"), "Ulpianus": Chara("Aegir"), "Skadi the Corrupting Heart": Chara("Aegir"),

    "Provence": Chara("Siracusa"), "Texas": Chara("Siracusa", "Solitary"), "Vulpisfoglia": Chara("Siracusa", "Swift"), "Aroma": Chara("Siracusa", "Arcane"), "Shamare": Chara("Siracusa", "Support"),
    "Angelina": Chara("Siracusa"), "Texas the Omertosa": Chara("Siracusa", "Assault"), "Suzuran": Chara("Siracusa", "Cover"), "Lappland": Chara("Siracusa"), "Lappland the Decadenza": Chara("Siracusa"),
    ...
    "Rose Salt": Chara("Cover"), "Civilight Eterna": Chara("Cover")
}
